  ...
  <head>
    ...
    <meta name="description" content="Default Place Search">
        ...
        <script src="https://apis.mappls.com/advancedmaps/api/42a862d898b2a6d4bd55ec502d483bfd/map_sdk?layer=vector&v=3.0&callback=initMap1"></script>
        <script src="https://apis.mappls.com/advancedmaps/api/42a862d898b2a6d4bd55ec502d483bfd/map_sdk_plugins?v=3.0"></script>
        <style>
        body {margin: 0}
    ...
    <body>
        <div id="map"></div>
        <input type="text" id="auto" name="auto" class="search-outer form-control as-input" placeholder="Search your destination" required="" spellcheck="false">
            <script>
        var map,marker;
        /*Map Initialization*/
        function initMap1(){
